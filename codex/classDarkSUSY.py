...
class DarkSUSY:
    ...
    def Obtein(self, var, particle="Muon", order=False):
        ...
        if var == "Entries":
            output = self.Entries
        elif var == "Charge" or var == "T" or var == "PT" or var == "Eta" \
                or var == "Phi" or var == "MassInv" or var == "D0" or var == "Dz":
            for i in range(self.Mu_DiMu.shape[0]):
                ...
                if var == "MassInv":
                    vet = [(self.File.Muon.At(self.Mu_DiMu[i, 1]).P4() +
                    ...
                    vet = [self.File.GetLeaf(particle + "." + var).GetValue(self.Mu_DiMu[i, 1]),
