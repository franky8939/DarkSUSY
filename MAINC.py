...
for num in range(1,10):
    # Entrada al nodo de trabajo
    os.system("srun --partition=general --constraint=broadwell --pty bash")
    ...
    if os.path.exists(MG5_DIR + "/models/MSSMD_UFO"): # Verificar la existencia del archivo
        shutil.rmtree(MG5_DIR + "/models/MSSMD_UFO")  # Borrar el archivo
