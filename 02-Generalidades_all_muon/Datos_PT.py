...
ax.hist(PT_CMS_all[PT_CMS_all < 100].T, bins=1000, alpha=0.5, density=True)
ax.hist(PT_HL_all[PT_HL_all < 100].T, bins=1000, alpha=0.5, density=True)
...
ax.hist(PT_CMS_3[PT_CMS_3 < 100].T, bins=1000, alpha=0.5, density=True)
ax.hist(PT_CMS_2[PT_CMS_2 < 100].T, bins=1000, alpha=0.5, density=True)
ax.hist(PT_CMS_1[PT_CMS_1 < 100].T, bins=1000, alpha=0.5, density=True)
ax.hist(PT_CMS_0[PT_CMS_0 < 100].T, bins=1000, alpha=0.5, density=True)
...
ax.hist(PT_HL_3[PT_HL_3 < 100].T, bins=1000, alpha=0.5, density=True)
ax.hist(PT_HL_2[PT_HL_2 < 100].T, bins=1000, alpha=0.5, density=True)
ax.hist(PT_HL_1[PT_HL_1 < 100].T, bins=1000, alpha=0.5, density=True)
ax.hist(PT_HL_0[PT_HL_0 < 100].T, bins=1000, alpha=0.5, density=True)
ax.legend(["Muon 1", "Muon 2", "Muon 3", "Muon 4"])
ax.set_xlabel(" Momento Transversal $P_T$(GeV)")
ax.set_ylabel(" Frecuencia Normalizada $f_N$")
...
ax.hist(PT_HL_3[PT_HL_3 < 30].T, bins=1000, alpha=0.5, density=True)
ax.hist(PT_CMS_3[PT_CMS_3 < 30].T, bins=1000, alpha=0.5, density=True)
...
ax.hist(PT_HL_2[PT_HL_2 < 50].T, bins=1000, alpha=0.5, density=True)
ax.hist(PT_CMS_2[PT_CMS_2 < 50].T, bins=1000, alpha=0.5, density=True)
...
ax.hist(PT_HL_1[PT_HL_1 < 70].T, bins=1000, alpha=0.5, density=True)
ax.hist(PT_CMS_1[PT_CMS_1 < 70].T, bins=1000, alpha=0.5, density=True)
...
fig.savefig("Datos_PT_for_Mu.png")
fig.show()
# hist1D(PT_CMS_all, PT_HL_all, bins=50, alpha=0.4, density=True)
